    ...
    const actionFormatter = (cell, row) => {
        return (
            <Button color="primary" className="m-2" size="sm" onClick={e => {
                ...
                history.push("/tahap4/edit", { req: param, active: active });
            }}>
    ...
    return (
        <>
            <Card>
                <CardBody>
                    <Breadcrumb>
                        <BreadcrumbItem><a href="/#" onClick={(e) => {e.preventDefault(); history.goBack()}}>Tahap IV</a></BreadcrumbItem>
