...
import projectLogo from '../../assets/images/logo/codeplay-logo.png';
    ...
    <>
      <div className="app-sidebar--header">
        <div className="app-sidebar-logo">
          <NavLink to="/" title="Coffeeapp - Gerai" className="app-sidebar-logo">
            <div className="app-sidebar-logo--icon">
              <img alt="Flats" src={projectLogo} />
            </div>
            <div className="app-sidebar-logo--text">
              <span>Coffeeapp - Gerai</span>
